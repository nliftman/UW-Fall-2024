...
teaching_tables[nrow(teaching_tables) + 1, ] <- list("Provide incentives and training for mentoring PhD students", "2.543702", "2.427367", "2.660037", "< 2.2e-16")
teaching_tables[nrow(teaching_tables) + 1, ] <- list("Create transparent and realistic faculty workload models that distribute workloads equitably across faculty in the department", "1.714653", "1.617789", "1.811517", "< 2.2e-16")
